 ...
 * 到发通告 - 始发
 */
public class TrainADOriginActivity extends ActivityEx {
	private ArrayList<TrainGoTo> trainGotoList = new ArrayList<TrainGoTo>();
	private final int limit = 20;
	private int startIndex = 0;
	private long totalItems = 0;
	private TrainADOriginAdapter mAdpater;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.trainad_origin);
	...
	private void initView() {
		gv_queryList = (PullRefreshListView) findViewById(R.id.lstOrigin);
		mAdpater = new TrainADOriginAdapter(this, trainGotoList);
		...
		btnShowMore = new Button(TrainADOriginActivity.this);
