 ...
 * 到发通告 - 所有 Adapter
 */
public class TrainADAllAdapter extends BaseAdapter {
    private LayoutInflater mInflater;
    private ArrayList<TrainGoTo> mList;
    private Context mContext;

    public TrainADAllAdapter(Context context, ArrayList<TrainGoTo> list) {
        super();
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        LogUtil.i(position + "  status -->" + trainGoTo.Status);
        ...
        holder.itemView.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                bundle.putString("StationCode", trainGoTo.StationCode);
        ...
        if (Property.StationCode.equals("SYB")) {
            ...
            holder.labTrainTakeOn.setText(mList.get(position).TakeOn);
