 ...
 * 到发通告 - 终到
 */
public class TrainADTerminalActivity extends ActivityEx {
	private ArrayList<TrainGoTo> trainGotoList = new ArrayList<TrainGoTo>();
	private final int limit = 20;
	private int startIndex = 0;
	private long totalItems = 0;
	private TrainADTerminalAdapter mAdpater;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.trainad_terminal);
	...
	private void initView() {
		gv_queryList = (PullRefreshListView) findViewById(R.id.lstTerminal);
		mAdpater = new TrainADTerminalAdapter(this, trainGotoList);
		...
		btnShowMore = new Button(TrainADTerminalActivity.this);
	...
	public class SearchReceiver extends BroadcastReceiver {
		...
		public void onReceive(Context context, Intent intent) {
			...
			if (flag == TrainADTabActivity.FLAG_SEARCH) {
				...
				startTime = bundle
						.getString(TrainADTabActivity.EXTRA_STARTTIME);
