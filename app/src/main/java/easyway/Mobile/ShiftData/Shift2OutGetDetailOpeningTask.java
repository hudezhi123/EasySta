...
public class Shift2OutGetDetailOpeningTask implements Serializable  {
...
public String toString() {
	return "Shift2OutGetDetailOpeningTask [Sd_RDeptId=" + Sd_RDeptId
			+ ", Sd_TssId=" + Sd_TssId + ", Sd_RStaffNames=" + Sd_RStaffNames
