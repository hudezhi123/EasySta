...
public class MyFileAdapter extends BaseExpandableListAdapter{
	...
	public MyFileAdapter(ArrayList<String> typeList,Map<String, ArrayList<SiteRule>> dataList, Activity act) {
		super();
	...
	public View getChildView(int groupPosition, int childPosition,
		...
		View child;
		if(convertView == null){
			child = View.inflate(act, R.layout.myfile_group, null);
		}else{
			child = convertView;
		}
