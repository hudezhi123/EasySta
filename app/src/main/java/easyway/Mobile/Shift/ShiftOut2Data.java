...
public class ShiftOut2Data implements Serializable {
	...
	public int getShift_Out_StaffId() {
		return Shift_Out_StaffId;
	}

	public void setShift_Out_StaffId(int shift_Out_StaffId) {
	...
	public String toString() {
		return "ShiftOut2Data [Shift_Id=" + Shift_Id + ", Shift_WorkType="
				+ Shift_WorkType + ", Shift_Out_DeptId=" + Shift_Out_DeptId
				+ ", Shift_Out_DeptName=" + Shift_Out_DeptName
				+ ", Shift_Out_StaffId=" + Shift_Out_StaffId
				+ ", Shift_Out_StaffName=" + Shift_Out_StaffName
				+ ", Shift_Out_Remark=" + Shift_Out_Remark
				+ ", Shift_Out_Voice=" + Shift_Out_Voice + ", Shift_Out_Dttm="
				+ Shift_Out_Dttm + ", Shift_In_DeptId=" + Shift_In_DeptId
				+ ", Shift_In_DeptName=" + Shift_In_DeptName
				+ ", Shift_In_StaffId=" + Shift_In_StaffId
				+ ", Shift_In_StaffName=" + Shift_In_StaffName
				+ ", Shift_In_Dttm=" + Shift_In_Dttm + "]";
