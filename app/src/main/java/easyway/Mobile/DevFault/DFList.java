 ...
 * 设备报障列表
 */
public class DFList extends ActivityEx {
...
//                    Toast.makeText(DFList.this, (String) msg.obj,
...
//                            Toast.LENGTH_SHORT).show();
    ...
    private void showDialogData() {
        ...
        if (getIntent().getBooleanExtra("shebei", false)) {
            LayoutInflater layoutInflater = LayoutInflater.from(DFList.this);
            View myLoginView = layoutInflater.inflate(R.layout.baozhang_data,
                    null);
            final EditText et_input = (EditText) myLoginView
                    .findViewById(R.id.et_input);

            AlertDialog dlg = new AlertDialog.Builder(DFList.this)
                    .setTitle("维修完成")
                    .setView(myLoginView)
    ...
    private void getRepairData(String data, int dfId, String dspIds) {
        ...
        WebServiceManager webServiceManager = new WebServiceManager(
                DFList.this, methodName, parmValues);
...
//		myhandle.sendMessage(msg);
    ...
    private void initView() {
        ...
        btnReporter.setOnClickListener(new OnClickListener() {

            @Override
            public void onClick(View v) {
                // TODO Auto-generated method stub
                Intent intent = new Intent(DFList.this, Contacts.class);
        ...
        DatePickerDialog buildDStart = new DatePickerDialog(DFList.this,
        ...
        DatePickerDialog buildDEnd = new DatePickerDialog(DFList.this,
    ...
    private void AddMoreListener() {
        gv_queryList.setOnScrollListener(new OnScrollListener() {
    ...
    private OnClickListener showDatePicker(final AlertDialog dialog) {
    ...
    private void GetDevFault() {
        ArrayList<DevFaultReport> list = new ArrayList<DevFaultReport>();
...
//			totalItems = JsonUtil.GetJsonLong(result, "total");
    ...
    private void Go2Detail() {
        gv_queryList.setOnItemClickListener(new OnItemClickListener() {
...
//				if(status == 1){
//					Intent go2Detail = new Intent(DFList.this,DRHandlerActivity.class);
...
//				}else if(status == 4){
                ...
                if ("SYB".equals(Property.StationCode)) {
                    Intent go2Detail = new Intent(DFList.this, SYBDRHandlerActivity.class);
                    go2Detail.putExtra("bean", base);
                    go2Detail.putExtra("status", status);
                    startActivity(go2Detail);
                } else {
